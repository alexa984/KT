...
namespace IS.Web.Controllers
{
    ...
    using ViewModels.BusinessAccountViewModels;
    ...
    public class BusinessAccountController : Controller
    {
        ...
        public BusinessAccountController(ApplicationUserManager userManager, ApplicationSignInManager signInManager)
        {
        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    userManager.AddToRole(userId, "Firm");
        ...
        public async Task<ActionResult> ResetPassword(ResetPasswordViewModel model)
        {
            ...
            if (user == null)
            {
                ...
                return RedirectToAction("ResetPasswordConfirmation", "BusinessAccount");
            }
            var result = await UserManager.ResetPasswordAsync(user.Id, model.Code, model.PasswordHash);
            if (result.Succeeded)
            {
                return RedirectToAction("ResetPasswordConfirmation", "BusinessAccount");
            }
